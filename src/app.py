...
def parse_source_file(file_name, project_name=None):
    ...
    if os.path.isdir(file_name):
        ...
        return process_directory(system, file_name, file_name)
...
def process_directory(system_node, root_name, file_path):
    for file in os.listdir(file_path):
        ...
        if os.path.isfile(full_name) and file.endswith('.py'):
            ...
            system_node.modules.append(module_node)
            ...
            system_node.packages.append(package_node)
